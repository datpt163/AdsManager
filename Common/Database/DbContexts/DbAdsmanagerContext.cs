            ...
            entity.HasMany(d => d.Pms).WithMany(p => p.AdsAccounts)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<AdsAccount>().WithMany()
                        ...
                        .HasConstraintName("adsAccountPms_ibfk_1"),
                    j =>
                    {
                        j.HasKey("AdsAccountId", "PmId")
                            .HasName("PRIMARY")
                            .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
                        j.ToTable("adsAccountPms");
                        j.HasIndex(new[] { "PmId" }, "pmId");
                        j.IndexerProperty<string>("AdsAccountId")
                            .HasMaxLength(60)
                            .IsFixedLength()
                            .HasColumnName("adsAccountId");
                        j.IndexerProperty<string>("PmId")
                            .HasMaxLength(100)
                            .IsFixedLength()
                            .HasColumnName("pmId");
                    });
